...
import core.general.menus.comment.items.CommentMenuItemGoToCommentAuthorPhotos;
...
public class CommentMenuItemGoToCommentAuthorPhotosTest extends AbstractCommentMenuItemTest_ {
	...
	public void menuIsInaccessibleIfCommentAuthorOwnerOfPhotoAndHasOneOrLessPhotoInGenre() {
		...
		assertCommentMenuItemAccess( accessStrategy, new CommentMenuItemGoToCommentAuthorPhotos(), initialConditions );
	}
	...
	private void checkIfMenuAccessibleIfCommentOwnerIsCallingItDependsFromShowOwnEntriesMenuSetting( final boolean isShowMenuForOwnEntriesConfigurationIsSwitchedOn, final CommentMenuItemAccessStrategy strategy ) {
		...
		assertCommentMenuItemAccess( strategy, new CommentMenuItemGoToCommentAuthorPhotos(), initialConditions );
	}
}
