<%@ page import="admin.controllers.configuration.activation.SystemConfigurationActivationModel" %>
...
<jsp:useBean id="systemConfigurationActivationModel" type="admin.controllers.configuration.activation.SystemConfigurationActivationModel" scope="request"/>
