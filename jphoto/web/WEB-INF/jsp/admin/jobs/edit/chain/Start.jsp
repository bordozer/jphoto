	...
	<form:form action="${eco:baseAdminUrlWithPrefix()}/jobs/${jobChainJobModel.job.jobType.prefix}/" id="FormName" name="FormName">
		...
		<table:table width="800">
			...
			<table:tr>
				...
				<table:td>
					<form:radiobuttons path="${jobRunModeIdControl}" items="${jobRunModeValues}" itemValue="id" itemLabel="nameTranslated" delimiter="<br />" htmlEscape="false" />
				</table:td>
			</table:tr>
		...
		<admin:jobFinish jobModel="${jobChainJobModel}" />

	</form:form>

	<js:confirmAction />

	<tags:springErrorHighliting bindingResult="${jobChainJobModel.bindingResult}"/>
