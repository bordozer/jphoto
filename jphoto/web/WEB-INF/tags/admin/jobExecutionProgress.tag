...
<c:if test="${not empty jobHistoryEntryDTO.savedJob}">
	<c:set var="linkToJob" value="<%=ApplicationContextHelper.getUrlUtilsService().getAdminSavedJobProgressLink( jobHistoryEntryDTO.getJobType(), jobHistoryEntryDTO.getJobHistoryEntryId() )%>" />
</c:if>
