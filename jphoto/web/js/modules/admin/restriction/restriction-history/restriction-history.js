define( ["modules/admin/restriction/restriction-history/restriction-history-model"
	...
	function init( entryId, translations, baseUrl, container ) {

		var restrictionHistoryModel = new Model.RestrictionHistoryModel( { entryId:entryId, translations: translations, baseUrl:baseUrl } );
