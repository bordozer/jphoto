define( ["components/user-picker/user-picker-model"
	...
	function init( controlName, initialUserId, callbackFunction, baseUrl, container ) {

		var userPickerModel = new Model.UserPickerModel( { controlName: controlName, initialUserId: initialUserId, baseUrl: baseUrl } );
