...
public class CommentMenuItemEditTest extends AbstractTestCase {
	...
	public void commentAuthorMenuTest() {
		...
		assertTrue( WRONG_MENU_TEXT, new CommentMenuItemEdit( testData.comment, testData.commentAuthor, services ).getMenuItemCommand().getMenuText().equals( "Edit your comment" ) );
	}
