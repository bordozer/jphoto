...
public class CommentAdminSubMenuItemLockUserTest extends AbstractCommentMenuItemTest_ {
	...
	public void commandTest() {
		...
		assertEquals( EXPECTED_AND_ACTUAL_RESULTS_ARE_DIFFERENT, command.getMenuCommand(), String.format( "adminLockUser( %d, '%s' );", commentAuthor.getId(), commentAuthor.getNameEscaped() ) );
	}
