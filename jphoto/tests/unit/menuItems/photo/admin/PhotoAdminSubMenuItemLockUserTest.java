...
public class PhotoAdminSubMenuItemLockUserTest extends AbstractPhotoMenuItemTest_ {
	...
	public void commandTest() {
		...
		assertEquals( EXPECTED_AND_ACTUAL_RESULTS_ARE_DIFFERENT, command.getMenuText(), translated(  String.format( "PhotoMenuItem: Restrict photo author: %s", photoAuthor.getNameEscaped() ) ) );
