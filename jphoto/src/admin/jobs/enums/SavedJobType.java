...
public enum SavedJobType {
	...
	, ARCHIVING( 17, "SavedJobType: Archiving", JobListTab.SYSTEM_JOBS, "archiving", "archiving.png" )
	...
	, RANK_VOTING_GENERATION( 6, "SavedJobType: Voting for users ranks in categories generation", JobListTab.PHOTO_ACTIONS, "data/rankVoting", "rankVotingGeneration.png" )
	, FAVORITES_GENERATION( 8, "SavedJobType: Favorite entries generation", JobListTab.PHOTO_ACTIONS, "data/favorites", "favoritesGeneration.png" )
