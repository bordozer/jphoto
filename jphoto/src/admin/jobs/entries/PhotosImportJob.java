...
public class PhotosImportJob extends AbstractDateRangeableJob {
	...
	public String getJobParametersDescription() {
		...
		switch ( importSource ) {
			...
			case PHOTOSIGHT:
				...
				builder.append( translatorService.translate( "Gender" ) ).append( ": " ).append( translatorService.translate( photosightParameters.getUserGender().getName() ) ).append( "<br />" );
	...
	public void setImportParameters( final ImportParameters importParameters ) {
