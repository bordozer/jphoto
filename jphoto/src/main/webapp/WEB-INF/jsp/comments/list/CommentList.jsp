...
<jsp:useBean id="photoCommentsListModel" type="com.bordozer.jphoto.ui.controllers.comment.list.PhotoCommentsListModel" scope="request"/>
        ...
        <script type="text/javascript">
            function markAllAsRead() {
                if (confirm("${eco:translate('Mark ALL unread comments as read?')}")) {
                    document.location.href = '${eco:baseUrl()}/members/${user.id}/comments/received/markAllAsRead/';
                    return true;
                }
                return false;
            }
