...
<jsp:useBean id="photoMarkListModel" type="com.bordozer.jphoto.ui.controllers.marks.list.PhotoMarkListModel" scope="request"/>
                    ...
                    <c:forEach var="votingCategory" items="${votingCategories}">
                        ...
                        <table:tdunderlined width="120" cssClass="text-centered">
                            ...
                            <c:if test="${isMaxAccessibleMark}">
                                ...
                                <html:img16 src="icons16/top-points.png"
                                            alt="${eco:translate1('MarkList: $1 set max accessible for him at voting time mark', eco:escapeHtml(user.name))}"/>
                            </c:if>
