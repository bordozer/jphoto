...
<%@ page import="com.bordozer.jphoto.ui.controllers.users.login.UserLoginModel" %>
...
<jsp:useBean id="userLoginModel" type="com.bordozer.jphoto.ui.controllers.users.login.UserLoginModel" scope="request"/>
    ...
    <eco:form action="${loginFormAction}">
        ...
        <table:table width="400">
            ...
            <table:tredit>
                ...
                <table:tddata>
                    <input class="ui-state-default ui-corner-all" type="text" id="${loginControl}" name="${loginControl}" value="${userLoginModel.userlogin}"
                           size="14"/>
                </table:tddata>
            </table:tredit>
