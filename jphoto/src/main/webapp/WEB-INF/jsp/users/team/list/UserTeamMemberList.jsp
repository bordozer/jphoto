...
<jsp:useBean id="userTeamMemberListModel" type="com.bordozer.jphoto.ui.controllers.users.team.list.UserTeamMemberListModel" scope="request"/>
                        ...
                        <table:tdicon>
                            <c:if test="${userTeamMemberPhotosQty == 0}">
                                <links:userTeamMemberDelete userTeamMember="${userTeamMember}">
                                    <html:img id="delete_member_${userTeamMember.id}" src="delete16.png" width="16" height="16"
                                              onclick="return deleteUserTeamMember();"/>
