...
<jsp:useBean id="userPhotoAlbumListModel" type="com.bordozer.jphoto.ui.controllers.users.photoAlbums.list.UserPhotoAlbumListModel" scope="request"/>
                    ...
                    <c:if test="${canEdit}">
                        ...
                        <table:tdicon>
                            <links:userPhotoAlbumDelete userId="${user.id}" albumId="${userPhotoAlbum.id}">
                                <html:img id="delete_album_${userPhotoAlbum.id}" src="delete16.png" width="16" height="16"
                                          onclick="return deleteUserPhotoAlbum();"/>
