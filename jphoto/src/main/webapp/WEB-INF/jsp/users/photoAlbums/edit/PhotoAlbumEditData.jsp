...
<%@ page import="com.bordozer.jphoto.ui.controllers.users.photoAlbums.edit.UserPhotoAlbumEditDataModel" %>
...
<jsp:useBean id="userPhotoAlbumEditDataModel" type="com.bordozer.jphoto.ui.controllers.users.photoAlbums.edit.UserPhotoAlbumEditDataModel"
             scope="request"/>
