<%@ page import="com.bordozer.jphoto.ui.elements.PhotoList" %>
...
<jsp:useBean id="userPhotoAlbumPhotosModel" type="com.bordozer.jphoto.ui.controllers.users.photoAlbums.photos.UserPhotoAlbumPhotosModel"
             scope="request"/>
