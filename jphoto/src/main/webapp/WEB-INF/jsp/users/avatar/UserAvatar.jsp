<%@ page import="com.bordozer.jphoto.core.services.utils.UserPhotoFilePathUtilsService" %>
<%@ page import="com.bordozer.jphoto.ui.context.ApplicationContextHelper" %>
<%@ page import="com.bordozer.jphoto.ui.controllers.users.avatar.UserAvatarModel" %>
...
<jsp:useBean id="userAvatarModel" type="com.bordozer.jphoto.ui.controllers.users.avatar.UserAvatarModel" scope="request"/>
