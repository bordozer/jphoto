<%@ page import="com.bordozer.jphoto.ui.controllers.users.password.change.ChangeUserPasswordModel" %>
...
<jsp:useBean id="changeUserPasswordModel" type="com.bordozer.jphoto.ui.controllers.users.password.change.ChangeUserPasswordModel" scope="request"/>
...
<c:set var="passwordRequirement"
       value="<%=changeUserPasswordModel.getDataRequirementService().getUserRequirement().getPasswordRequirement( false )%>"/> <%-- TODO: set to true--%>
