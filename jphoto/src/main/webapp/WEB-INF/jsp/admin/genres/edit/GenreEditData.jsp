<%@ page import="com.bordozer.jphoto.admin.controllers.genres.edit.GenreEditDataModel" %>
...
<jsp:useBean id="genreEditDataModel" type="com.bordozer.jphoto.admin.controllers.genres.edit.GenreEditDataModel" scope="request"/>
