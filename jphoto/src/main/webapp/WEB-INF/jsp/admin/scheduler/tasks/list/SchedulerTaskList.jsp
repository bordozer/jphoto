<%@ page import="com.bordozer.jphoto.admin.controllers.scheduler.tasks.list.SchedulerTaskListController" %>
...
<jsp:useBean id="schedulerTaskListModel" type="com.bordozer.jphoto.admin.controllers.scheduler.tasks.list.SchedulerTaskListModel" scope="request"/>
...
<tags:page pageModel="${schedulerTaskListModel.pageModel}">
    ...
    <form:form action="" method="POST" modelAttribute="schedulerTaskListModel">
        ...
        <div style="width: 95%; float: left; height: 100%; margin: 10px;">
            ...
            <html:img32 src="scheduler/schedulerDeteteTask.png" alt="${eco:translate('SchedulerTaskList: Delete selected scheduler tasks')}"
                        onclick="submitSchedulerTaskListForm( '${deleteGroupAction}' )"/>
            ...
            <c:if test="${schedulerEnabled}">
                <c:if test="${schedulerRunning}">
                    <links:schedulerStop>
                        <html:img32 src="scheduler/SchedulerIsRunning.png"
                                    alt="${eco:translate('SchedulerTaskList: The Scheduler is running. Click to stop scheduler.')}"/>
                    </links:schedulerStop>
                </c:if>

                <c:if test="${not schedulerRunning}">
                    <links:schedulerRun>
                        <html:img32 src="scheduler/SchedulerIsStopped.png"
                                    alt="${eco:translate('SchedulerTaskList: The Scheduler is stopped. Click to run scheduler.')}"/>
                    </links:schedulerRun>
                </c:if>
            </c:if>
            ...
            <html:img32 src="scheduler/schedulerTaskActivate.png" alt="${eco:translate('SchedulerTaskList: Activate selected scheduler tasks')}"
                        onclick="submitSchedulerTaskListForm( '${activateGroupAction}' )"/>
            <html:img32 src="scheduler/schedulerTaskDeactivate.png" alt="${eco:translate('SchedulerTaskList: Deactivate selected scheduler tasks')}"
                        onclick="submitSchedulerTaskListForm( '${deactivateGroupAction}' )"/>
                ...
                <jsp:body>
                    ...
                    <c:forEach var="scheduledTasksData" items="${schedulerTaskListModel.scheduledTasksData}">
                        ...
                        <table:tr>
                            ...
                            <table:tdicon cssClass="${css}">
                                <a href="${eco:baseAdminUrl()}/scheduler/tasks/${schedulerTaskId}/delete/"
                                   title="${eco:translate1('SchedulerTaskList: Delete task \'$1\'', schedulerTask.name)}">
                            ...
                            <table:td cssClass="${css}">
                                <a href="${eco:baseAdminUrl()}/scheduler/tasks/${schedulerTaskId}/info/"
                                   title="${eco:translate1('SchedulerTaskList: View info \'$1\'', schedulerTask.name)}">
                                        ${schedulerTask.name}
                                </a>
                            </table:td>
