<%@ page import="com.bordozer.jphoto.core.services.entry.AnonymousDaysService" %>
<%@ page import="com.bordozer.jphoto.core.services.utils.DateUtilsService" %>
...
<jsp:useBean id="anonymousDaysAdminModel" type="com.bordozer.jphoto.admin.controllers.anonymousDays.AnonymousDaysAdminModel" scope="request"/>
    ...
    <script type="text/javascript">
        ...
        require(['jquery', 'jquery_ui', 'jscal2'], function ($) {
            ...
            function addAnonymousDay(pickerDate, instance) {
                ...
                showUIMessage_Notification(pickerDate + ' ' + message);
            }
