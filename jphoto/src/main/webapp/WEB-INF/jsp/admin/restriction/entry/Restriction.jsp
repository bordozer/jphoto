...
<%@ page import="com.bordozer.jphoto.ui.services.ajax.AjaxService" %>
<%@ page import="org.jabsorb.JSONRPCBridge" %>
<%@ taglib prefix="eco" uri="http://taglibs" %>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>

<jsp:useBean id="restrictionModel" type="com.bordozer.jphoto.admin.controllers.restriction.entry.RestrictionModel" scope="request"/>
...
<head>
    ...
    <link href="${baseUrl}/css/jphoto.legacy.css" rel="stylesheet" type="text/css"/>
