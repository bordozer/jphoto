...
<jsp:useBean id="systemConfigurationListModel" type="com.bordozer.jphoto.admin.controllers.configuration.list.SystemConfigurationListModel"
             scope="request"/>
...
<tags:page pageModel="${systemConfigurationListModel.pageModel}">
    ...
    <links:configurationNew>
        <html:img id="addSystemConfigurationIcon" src="add32.png" width="32" height="32"
                  alt="${eco:translate('System configuration list: Create new system configuration')}"/>
    </links:configurationNew>
    ...
    <table:table width="100%" oddEven="true">
        ...
        <c:forEach var="systemConfiguration" items="${systemConfigurations}">
            <table:tr>
                ...
                <table:tdunderlined width="20">
                    <links:configurationEdit systemConfigurationId="${systemConfiguration.id}">
                        <html:img16 src="edit16.png"
                                    alt="${eco:translate1('System configuration list: System configuration list: Edit $1', systemConfiguration.name)}"/>
                ...
                <table:tdunderlined width="20">
                    ...
                    <c:if test="${!systemConfiguration.defaultConfiguration && !systemConfiguration.activeConfiguration}">
                        <html:img16 src="delete16.png" onclick="deleteConfiguration();"
                                    alt="${eco:translate1('System configuration list: Delete $1', systemConfiguration.name)}"/>
                    ...
                    <c:if test="${systemConfiguration.activeConfiguration}">
                        <c:set var="deleteMessage"
                               value="${eco:translate('System configuration list: The active system configuration can not be deleted. Activate another configuration and then delete this one.')}"/>
                        <html:img16 src="cannotdelete.png" onclick="showUIMessage_Information( '${deleteMessage}' );"
                                    alt="${eco:translate1('System configuration list: Delete $1', systemConfiguration.name)}"/>
                    </c:if>
                ...
                <table:tdunderlined width="20">
                    <c:if test="${systemConfiguration.defaultConfiguration}">
                        <html:img16 src="system-configuration-default.png"
                                    alt="${eco:translate('System configuration list: The default system configuration')}"/>
                    </c:if>
                </table:tdunderlined>
                ...
                <table:tdunderlined width="20">
                    <c:if test="${systemConfiguration.activeConfiguration}">
                        ...
                        <html:img16 src="system-configuration-active.png" alt="${eco:translate('System configuration list: The active system configuration')}"
                                    onclick="showUIMessage_Information('${message}');"/>
                    </c:if>
                    ...
                    <c:if test="${not systemConfiguration.activeConfiguration}">
                        <a href="${eco:baseAdminUrl()}/configuration/activation/?id=${systemConfiguration.id}">
                            <html:img16 src="system-configuration-inactive.png"
                                        alt="${eco:translate1('System configuration list: Activate $1', systemConfiguration.name)}"/>
                        </a>
                    </c:if>
                </table:tdunderlined>
