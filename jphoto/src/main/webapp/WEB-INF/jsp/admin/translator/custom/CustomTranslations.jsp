...
<jsp:useBean id="customTranslationsModel" type="com.bordozer.jphoto.admin.controllers.translator.custom.CustomTranslationsModel" scope="request"/>
    ...
    <form:form modelAttribute="customTranslationsModel" method="POST" action="${eco:baseAdminUrl()}/translations/custom/">
        ...
        <table:table width="400px">
            ...
            <table:tr>
                ...
                <table:td/>
                <table:td>
                    <form:radiobuttons path="selectedLanguageId" items="${languageValues}" itemValue="id" itemLabel="name"
                                       onchange="$( '#customTranslationsModel' ).submit();" delimiter="<br />"/>
                </table:td>
            </table:tr>
