<%@ page import="com.bordozer.jphoto.admin.controllers.translator.TranslationMode" %>
<%@ page import="com.bordozer.jphoto.core.services.translator.Language" %>
...
<jsp:useBean id="translatorModel" type="com.bordozer.jphoto.admin.controllers.translator.TranslatorModel" scope="request"/>
        ...
        <div class="left-pane">
            ...
            <c:if test="${translatorModel.translationMode != 'UNUSED_TRANSLATIONS' }">
                ...
                <c:forEach var="language" items="${languages}">
                    ...
                    <a href="${eco:baseAdminUrl()}/translator/${translatorModel.translationMode.prefix}/language/${language.code}/"
                       class="block-background">${eco:translate(language.name)}</a>
