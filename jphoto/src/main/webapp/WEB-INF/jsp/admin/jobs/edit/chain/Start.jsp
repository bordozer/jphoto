<%@ page import="com.bordozer.jphoto.admin.controllers.jobs.edit.chain.JobChainJobModel" %>
<%@ page import="com.bordozer.jphoto.admin.jobs.enums.JobRunMode" %>
...
<jsp:useBean id="jobChainJobModel" type="com.bordozer.jphoto.admin.controllers.jobs.edit.chain.JobChainJobModel" scope="request"/>
			...
			<jsp:attribute name="jobForm">
				...
				<table:table width="800">
					...
					<table:tr>
						...
						<table:td>
							<form:radiobuttons path="${jobRunModeIdControl}" items="${jobRunModeValues}" itemValue="id" itemLabel="name" delimiter="<br />"
                                               htmlEscape="false"/>
						</table:td>
					</table:tr>
					...
					<table:tr>
						...
						<table:td>
							<form:checkbox path="${stopNextJobsInChainIfErrorControl}" value="ON"
                                           disabled="${jobChainJobModel.jobRunModeId != jobRunModeSeriallyId}"/>
						</table:td>
					</table:tr>
