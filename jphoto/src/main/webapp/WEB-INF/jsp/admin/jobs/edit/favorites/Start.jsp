<%@ page import="com.bordozer.jphoto.admin.controllers.jobs.edit.favorites.FavoritesJobModel" %>
...
<jsp:useBean id="favoritesJobModel" type="com.bordozer.jphoto.admin.controllers.jobs.edit.favorites.FavoritesJobModel" scope="request"/>
...
<c:set var="favoriteEntriesIds"
       value="<%=GenericTranslatableList.favoriteEntryTypeTranslatableList( EnvironmentContext.getLanguage(), ApplicationContextHelper.getTranslatorService() ).getEntries()%>"/>
