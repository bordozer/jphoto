<%@ page import="com.bordozer.jphoto.admin.controllers.jobs.edit.activityStream.ActivityStreamCleanupJobModel" %>
...
<jsp:useBean id="activityStreamCleanupJobModel" type="com.bordozer.jphoto.admin.controllers.jobs.edit.activityStream.ActivityStreamCleanupJobModel"
             scope="request"/>
...
<c:set var="activityTypes"
       value="<%=GenericTranslatableList.activityTypeList( EnvironmentContext.getLanguage(), ApplicationContextHelper.getTranslatorService() ).getEntries()%>"/>
			...
			<table:table border="0" width="700">
				...
				<table:tr>
					...
					<table:tddata>
						...
						<br/>
						<br/>
						<form:checkboxes path="${activity_stream_type_ids_to_delete_control}" items="${activityTypes}" itemValue="id" itemLabel="name"
                                         delimiter="<br />"
