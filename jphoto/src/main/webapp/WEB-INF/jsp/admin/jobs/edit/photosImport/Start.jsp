<%@ page import="com.bordozer.jphoto.admin.controllers.jobs.edit.photosImport.PhotosImportModel" %>
<%@ page import="com.bordozer.jphoto.admin.controllers.jobs.edit.photosImport.PhotosImportSource" %>
<%@ page import="com.bordozer.jphoto.core.general.photo.PhotoImageLocationType" %>
...
<jsp:useBean id="photosImportModel" type="com.bordozer.jphoto.admin.controllers.jobs.edit.photosImport.PhotosImportModel" scope="request"/>
            ...
            <div id="${filesystemImportDivId}" class="row">
                ...
                <div class="col-lg-12">
					...
					<table:table width="100%">
						...
						<table:tr>
							<table:td colspan="2">
								<c:set var="userPickerId"
                                       value="${not empty photosImportModel.assignAllGeneratedPhotosToUser ? photosImportModel.assignAllGeneratedPhotosToUser.id : 0}"/>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <js:checkboxMassChecker checkboxClass="remote-photo-site-category-nude"
                                                    initiallyChecked="${photosImportModel.remotePhotoSiteImport_importNudeContentByDefault}"/>
