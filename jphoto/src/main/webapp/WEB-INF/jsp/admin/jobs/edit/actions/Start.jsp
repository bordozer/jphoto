<%@ page import="com.bordozer.jphoto.admin.controllers.jobs.edit.action.PhotoActionGenerationModel" %>
...
<jsp:useBean id="jobModelPhotoAction" type="com.bordozer.jphoto.admin.controllers.jobs.edit.action.PhotoActionGenerationModel" scope="request"/>
