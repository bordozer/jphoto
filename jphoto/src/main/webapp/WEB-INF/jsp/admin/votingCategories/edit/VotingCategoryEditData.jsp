<%@ page import="com.bordozer.jphoto.admin.controllers.votingCategories.edit.VotingCategoryEditDataModel" %>
...
<jsp:useBean id="votingCategoryEditDataModel" type="com.bordozer.jphoto.admin.controllers.votingCategories.edit.VotingCategoryEditDataModel"
             scope="request"/>
...
<tags:page pageModel="${votingCategoryEditDataModel.pageModel}">
    ...
    <eco:form action="${eco:baseAdminUrl()}/${entityUrl}/save/">
        ...
        <table:table width="600" border="0">
            ...
            <table:separatorInfo colspan="2" height="50"
                                 title="${isNew ? eco:translate('Voting category edit: New voting category')  : votingCategoryEditDataModel.votingCategoryName}"/>
            ...
            <table:tredit>
                ...
                <table:tddata>
                    ...
                    <%--<jsp:attribute name="inputField">--%>
                    <html:textarea inputId="${votingCategoryDescriptionControl}" inputValue="${votingCategoryEditDataModel.votingCategoryDescription}"
                                   title="${eco:translate( 'Appraisal categories: Description' )}" hint="${descriptionRequirement}"/>
                    <%--</jsp:attribute>--%>
                    <%--</tags:inputHint>--%>
                </table:tddata>
            </table:tredit>
