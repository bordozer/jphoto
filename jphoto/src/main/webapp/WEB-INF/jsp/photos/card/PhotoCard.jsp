<%@ page import="com.bordozer.jphoto.core.enums.FavoriteEntryType" %>
...
<%@ page import="com.bordozer.jphoto.ui.controllers.comment.edit.PhotoCommentModel" %>
...
<jsp:useBean id="photoCardModel" type="com.bordozer.jphoto.ui.controllers.photos.card.PhotoCardModel" scope="request"/>
...
<tags:page pageModel="${photoCardModel.pageModel}">
    ...
    <div class="row"> <%-- comments, info, voting --%>
        ...
        <div class="col-lg-8"> <%-- description and comments column --%>
            ...
            <c:if test="${photoCardModel.commentingValidationResult.validationPassed}">
                <comments:commentForm photo="${photo}" minCommentLength="${photoCardModel.minCommentLength}"
                                      maxCommentLength="${photoCardModel.maxCommentLength}"
                                      usedDelayBetweenComments="${photoCardModel.usedDelayBetweenComments}"/>
            </c:if>

            <c:if test="${photoCardModel.commentingValidationResult.validationFailed}">
                <tags:validationResult title_t="ValidationResult: You can not comment the photo"
                                       validationMessage="${photoCardModel.commentingValidationResult.validationMessage}"/>
            </c:if>
            ...
            <%-- / description and comments column --%>
    ...
    <div id="${photoDiv}" style="width: ${originalDimension.width}px; height:${originalDimension.height}px;display: none;"
         onclick="fadeoutAndCloseMessageBox( '${photoDiv}' );">
        <img id="showPhoto_${photo.id}" src="${imageUrl}" alt="${photoNameEscaped}" title="${photoNameEscaped}" width="${originalDimension.width}"
