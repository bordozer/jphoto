...
<c:set var="favoriteEntryTypeName" value="<%=FavoriteEntryType.FAVORITE_PHOTOS.getName()%>"/>

<a href="${link}" title="${eco:translate1("Links: favorite photos of $1", userNameEscaped)}">${eco:translate(favoriteEntryTypeName)}</a>
