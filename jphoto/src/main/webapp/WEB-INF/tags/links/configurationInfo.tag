...
<c:set var="configurationEditUrl"
       value="<%=ApplicationContextHelper.getUrlUtilsService().getAdminConfigurationTabLink( systemConfigurationId, configurationTab.getKey() )%>"/>
