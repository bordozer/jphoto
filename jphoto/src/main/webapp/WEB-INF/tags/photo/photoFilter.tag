...
<%@ tag import="com.bordozer.jphoto.ui.controllers.photos.list.PhotoFilterSortColumn" %>
<%@ tag import="com.bordozer.jphoto.ui.controllers.photos.list.PhotoFilterSortOrder" %>
...
<jsp:useBean id="photoFilterModel" type="com.bordozer.jphoto.ui.controllers.photos.list.PhotoFilterModel" scope="request"/>
        ...
        <div class="panel-body">
            ...
            <table:table width="600">
                ...
                <table:tr>
                    ...
                    <table:tddata>
                        <form:checkboxes path="photoAuthorMembershipTypeIds" items="${membershipTypeListValues}" itemValue="id" itemLabel="name"
                                         delimiter="<br />"/>
                    </table:tddata>
                </table:tr>
