<%@ tag import="com.bordozer.jphoto.ui.controllers.photos.groupoperations.PhotoGroupOperationModel" %>
...
<%@ attribute name="photoList" required="true" type="com.bordozer.jphoto.ui.elements.PhotoList" %>
            ...
            <c:if test="${totalPhotos > 0}">
                ...
                <div class="row row-bottom-padding-10">
                    ...
                    <div class="col-lg-2 text-right">
                        <photo:photoAllBestLink linkToFullList="${photoList.linkToFullList}"
                                                linkToFullListText="${eco:translate(photoList.linkToFullListText)}"/>
                    </div>
                </div>
            </c:if>
