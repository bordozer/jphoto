<%@ tag import="com.bordozer.jphoto.admin.controllers.jobs.edit.DateRangableModel" %>
<%@ tag import="com.bordozer.jphoto.admin.jobs.enums.DateRangeType" %>
...
<c:set var="dateRangeTypes"
       value="<%=GenericTranslatableList.dateRangeTypeTranslatableList( EnvironmentContext.getLanguage(), ApplicationContextHelper.getTranslatorService() )%>"/>
    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <form:radiobuttons path="${dateRangeTypeIdControl}" items="${dateRangeTypes.entries}" itemValue="id" itemLabel="name"
                                   onchange="setVisibility();" delimiter="&nbsp;&nbsp;&nbsp;" htmlEscape="false"/>
            </div>
        </div>

        <hr/>

        <div id='dateRangeDiv' class="row"
             <c:if test="${dateRangeTypeId != dateRangeId}">style="display: none;" </c:if> >
            <div class="col-lg-12">
        ...
        <div id='timePeriodDiv' class="row"
             <c:if test="${dateRangeTypeId != timePeriodId}">style="display: none;" </c:if> >
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <html:input fieldId="${timePeriodControl}" fieldValue="${timePeriod}" size="3"
                                    onchange="processTimePeriodChange();"/> ${eco:translate('Date range: date range tag => parameters => days')}
                    </div>
                </div>
        ...
        <div id='currentTimeDiv' class="row"
             <c:if test="${dateRangeTypeId != currentTimeId}">style="display: none;" </c:if> >
...
<c:set var="jsDateFormat" value="yy-mm-dd"/>
