<%@ tag import="com.bordozer.jphoto.core.services.translator.Language" %>
<%@ tag import="com.bordozer.jphoto.core.services.translator.TranslatorService" %>
<%@ tag import="com.bordozer.jphoto.rest.editableList.team.UserTeamTranslationDTO" %>
...
<%@ tag import="com.bordozer.jphoto.ui.translatable.GenericTranslatableEntry" %>
