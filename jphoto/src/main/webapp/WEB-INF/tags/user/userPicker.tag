...
<%@ attribute name="user" type="com.bordozer.jphoto.core.general.user.User" required="false" %>
        ...
        <div id="foundMemberLinkDiv" style="float :right; width: 100%; height: 30px;">
            <div id="foundMemberResetDiv" style="float: left; width: 7%; height: 100%; text-align: center;">
                <c:if test="${not empty user}">
                    <img src="${resetFoundMemberImg}" alt="${resetFoundMemberHint}" title="${resetFoundMemberHint}" width="16" height="16"
                         onclick="resetFoundMember();"/>
                </c:if>
            </div>
