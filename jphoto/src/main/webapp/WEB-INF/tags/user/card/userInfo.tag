<%@ tag import="com.bordozer.jphoto.core.services.security.SecurityService" %>
...
<%@ tag import="com.bordozer.jphoto.ui.controllers.users.edit.UserEditDataValidator" %>
<%@ tag import="com.bordozer.jphoto.ui.services.menu.entry.items.EntryMenuType" %>
<%@ tag import="com.bordozer.jphoto.core.services.utils.DateUtilsService" %>
...
<%@ attribute name="entryMenu" required="true" type="com.bordozer.jphoto.ui.services.menu.entry.items.EntryMenu" %>
