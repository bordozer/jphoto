<%@ tag import="com.bordozer.jphoto.admin.controllers.configuration.edit.ConfigurationEditModel" %>
<%@ tag import="com.bordozer.jphoto.core.enums.YesNo" %>
<%@ taglib prefix="eco" uri="http://taglibs" %>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>

<%@ taglib prefix="html" tagdir="/WEB-INF/tags/html" %>

<%@ attribute name="configuration" required="true" type="com.bordozer.jphoto.core.general.configuration.Configuration" %>
