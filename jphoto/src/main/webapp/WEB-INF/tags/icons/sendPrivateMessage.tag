...
<%@ attribute name="toUser" required="true" type="com.bordozer.jphoto.core.general.user.User" %>
...
<html:img16 src="sendPrivateMessageToUser16.png" alt="${eco:translate('Links: Send private message')}"
            onclick="sendPrivateMessage( ${fromUserId}, ${toUserId}, '${eco:escapeHtml(toUser.name)}'${callbackText} );"/>
