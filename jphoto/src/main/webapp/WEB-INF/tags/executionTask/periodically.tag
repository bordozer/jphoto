...
<%@ tag import="com.bordozer.jphoto.core.general.executiontasks.PeriodUnit" %>
...
<c:set var="periodUnits"
       value="<%=GenericTranslatableList.schedulerPeriodTranslatableList( EnvironmentContext.getLanguage(), ApplicationContextHelper.getTranslatorService() ).getEntries()%>"/>
