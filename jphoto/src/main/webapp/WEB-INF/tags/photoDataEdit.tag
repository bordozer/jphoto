<%@ tag import="com.bordozer.jphoto.core.general.configuration.ConfigurationKey" %>
...
<%@ attribute name="photoEditDataModel" type="com.bordozer.jphoto.ui.controllers.photos.edit.PhotoEditDataModel" %>
...
<c:set var="yesNoValues"
       value="<%=GenericTranslatableList.yesNoTranslatableList( EnvironmentContext.getLanguage(), ApplicationContextHelper.getTranslatorService() ).getEntries()%>"/>
...
<form:form modelAttribute="photoEditDataModel" method="post" action="${eco:baseUrl()}/photos/save/">
    ...
    <table:table width="1000px" border="0">
        ...
        <table:tredit>
            ...
            <table:tddata>
                <form:radiobuttons path="commentsAllowanceId" items="${photoEditDataModel.accessibleCommentAllowancesTranslatableList.entries}" itemValue="id"
        ...
        <table:tredit>
            ...
            <table:tddata>
                <form:radiobuttons items="${yesNoValues}" path="sendNotificationEmailAboutNewPhotoComment" itemValue="id" itemLabel="name" htmlEscape="false"
                                   delimiter="&nbsp;&nbsp;&nbsp;&nbsp;"/>
            </table:tddata>
        ...
        <table:tredit>
            ...
            <table:tddata>
                <form:radiobuttons path="votingAllowanceId" items="${photoEditDataModel.accessibleVotingAllowancesTranslatableList.entries}" itemValue="id"
                                   itemLabel="name" delimiter="<br />"/>
            </table:tddata>
        </table:tredit>
