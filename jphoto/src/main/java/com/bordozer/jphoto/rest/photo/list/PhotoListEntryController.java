...
public class PhotoListEntryController extends AbstractPhotoListEntryController {
    ...
    public PhotoEntryDTO photoListEntry(final Photo photo, final User accessor, final Language language) {
        ...
        dto.setIconTitlePhotoIsInAlbum(translatorService.translate("Photo preview: The photo is in album com.bordozer.jphoto.admin icon", language));
        dto.setIconTitleNudeContent(showAdminFlag_nude && !canContainNudeContent ? translatorService.translate("Photo preview: Category $1 can not contain NUDE but it does!!!", language, genreName) : translatorService.translate("Photo preview: The photo has nude content com.bordozer.jphoto.admin icon", language));
