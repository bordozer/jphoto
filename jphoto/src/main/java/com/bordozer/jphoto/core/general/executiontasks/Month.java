...
public enum Month implements IdentifiableNameable {
    ...
    JANUARY(Calendar.JANUARY, "Month: january", "JAN"), FEBRUARY(Calendar.FEBRUARY, "Month: february", "FEB"), MARCH(Calendar.MARCH, "Month: march", "MAR"), APRIL(Calendar.APRIL, "Month: april", "APR"), MAY(Calendar.MAY, "Month: may", "MAY"), JUNE(Calendar.JUNE, "Month: june", "JUN"), JULY(Calendar.JULY, "Month: july", "JUL"), AUGUST(Calendar.AUGUST, "Month: august", "AUG"), SEPTEMBER(Calendar.SEPTEMBER, "Month: september", "SEP"), OCTOBER(Calendar.OCTOBER, "Month: october", "OCT"), NOVEMBER(Calendar.NOVEMBER, "Month: november", "NOV"), DECEMBER(Calendar.DECEMBER, "Month: december", "DEC");
