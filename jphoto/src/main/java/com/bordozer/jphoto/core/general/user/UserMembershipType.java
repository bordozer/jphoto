...
public enum UserMembershipType implements IdentifiableNameable {
    ...
    AUTHOR(1, "UserMembershipType: author", "UserMembershipType: author plural", "author.png"), MODEL(2, "UserMembershipType: model", "UserMembershipType: model plural", "model.png"), MAKEUP_MASTER(3, "UserMembershipType: makeup master", "UserMembershipType: makeup master plural", "makeup.png");
