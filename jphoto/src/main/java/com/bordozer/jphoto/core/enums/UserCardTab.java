...
public enum UserCardTab {
    ...
    BRIEF_USER__OVERVIEW("brief", "UserCardTab: Overview"), PERSONAL_DATA("personal", "UserCardTab: Personal data"), PHOTOS_OVERVIEW("photos", "UserCardTab: Photos overview"), STATISTICS("statistics", "UserCardTab: Statistics"), TEAM("team", "UserCardTab: Team"), ALBUMS("albums", "UserCardTab: Albums"), ACTIVITY_STREAM("activity", "UserCardTab: Activity stream");
