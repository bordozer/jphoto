...
public enum ConfigurationDataType {
    ...
    INTEGER(1, "ConfigurationDataType: Int number"), STRING(2, "ConfigurationDataType: String"), BYTE(3, "ConfigurationDataType: Bytes"), FLOAT(4, "ConfigurationDataType: Float number"), ARRAY_OF_STRINGS(5, "ConfigurationDataType: String array"), ARRAY_OF_INTEGERS(6, "ConfigurationDataType: Integer Array"), YES_NO(7, "ConfigurationDataType: Yes/No");
