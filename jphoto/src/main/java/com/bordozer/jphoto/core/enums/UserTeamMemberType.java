...
public enum UserTeamMemberType implements IdentifiableNameable {
    ...
    MODEL(1, "UserTeamMemberType: Model", "model.png"), PHOTOGRAPH(2, "UserTeamMemberType: Photograph", "photo.png"), MAKEUP_MASTER(3, "UserTeamMemberType: Makeup master", "makeup.png"), HAIR_DRESSER(4, "UserTeamMemberType: Hair dresser", "hair.png");
