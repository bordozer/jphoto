...
public enum PhotosImportSource implements IdentifiableNameable {
    ...
    FILE_SYSTEM(1, "PhotosImportSource: File system", "", ""), PHOTOSIGHT(2, "PhotosImportSource: Photosight", "photosight.ru", "photosight.ru"), PHOTO35(3, "PhotosImportSource: 35photo", "35photo.ru", "35photo.ru"), NATURELIGHT(4, "PhotosImportSource: naturelight", "naturelight.ru", "naturelight.ru");
