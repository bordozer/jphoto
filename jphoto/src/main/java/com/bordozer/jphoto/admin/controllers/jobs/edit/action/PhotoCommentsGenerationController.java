...
@Controller
@RequestMapping("/admin/jobs/data/comments")
public class PhotoCommentsGenerationController extends PhotoActionGenerationController {

    @RequestMapping(method = RequestMethod.GET, value = "/")
    public ModelAndView showForm(@ModelAttribute(JOB_MODEL_NAME) PhotoActionGenerationModel model) {
        return doShowForm(model, SavedJobType.ACTIONS_GENERATION_COMMENTS);
    }
}
