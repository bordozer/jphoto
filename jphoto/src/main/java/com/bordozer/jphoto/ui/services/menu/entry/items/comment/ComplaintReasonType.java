...
public enum ComplaintReasonType {
    ...
    COMMENT_SPAM(1, "ComplaintReasonType: Spam"), COMMENT_SWORD_WORDS(2, "ComplaintReasonType: Sword words"), COMMENT_CUSTOM_COMPLAINT(3, "ComplaintReasonType: Custom complaint"), PHOTO_COPYRIGHT_COMPLAINT(4, "ComplaintReasonType: Photo copyright complaint");
