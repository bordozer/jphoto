...
) ENGINE=InnoDB AUTO_INCREMENT=3286 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=203;
...
) ENGINE=InnoDB AUTO_INCREMENT=3254225 DEFAULT CHARSET=utf8;
...
CREATE TABLE `genres` (
  ...
  UNIQUE KEY `idx_id` (`id`) USING BTREE,
  UNIQUE KEY `idx_name` (`name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=910;
...
) ENGINE=InnoDB AUTO_INCREMENT=301 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=154;
...
CREATE TABLE `jobExecutionHistory` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1322759 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=7475741 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=2077722 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=3735033 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=1049647 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=11047 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=231570 DEFAULT CHARSET=utf8;
...
DELETE FROM `photoAwards`;
DELETE FROM `photoRatings`;
DELETE FROM `photoAwards`;
DELETE FROM `photoAlbums`;
DELETE FROM `photoTeam`;
DELETE FROM photos;

DELETE FROM `privateMessage`;
DELETE FROM `usersRanksByGenresVoting`;
DELETE FROM `usersRanksByGenres`;
...
DELETE FROM `jobParameters`;
DELETE FROM `job`;

DELETE FROM jobExecutionHistoryParameters;
...
SET users.`notificationEmailAboutNewPhotosOfFavoriteMembers` = 0,
 ...
 UPDATE photos SET photos.`votingAllowance` = 2;
 UPDATE users SET defaultPhotoVotingAllowanceId = 2;
