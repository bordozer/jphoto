...
public class NewPhotoOfSignedAuthorPrivateMessageTextStrategy extends AbstractNotificationTextStrategy {
	...
	public String getNotificationSubject() {
		return String.format( "New Photo Of Signed Author Private Message - Subject: %s has uploaded new photo '%s'", getPhotoAuthor(), services.getEntityLinkUtilsService().getPhotoCardLink( photo ) );
	}

	@Override
	public String getNotificationText() {
		return String.format( "New Photo Of Signed Author Private Message - Body: %s has uploaded new photo '%s'", getPhotoAuthor(), services.getEntityLinkUtilsService().getPhotoCardLink( photo ) );
	}
