...
public class NewPhotoOfFavoriteAuthorEmailTextStrategy extends AbstractNotificationTextStrategy {
	...
	public String getNotificationSubject() {
		return String.format( "New Photo Of Favorite Author - Email Subject: %s has uploaded new photo '%s'", getPhotoAuthor(), services.getEntityLinkUtilsService().getPhotoCardLink( photo ) );
	}

	@Override
	public String getNotificationText() {
		return String.format( "New Photo Of Favorite Author - Email Body: %s has uploaded new photo '%s'", getPhotoAuthor(), services.getEntityLinkUtilsService().getPhotoCardLink( photo ) );
	}
