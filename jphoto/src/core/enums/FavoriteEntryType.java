...
public enum FavoriteEntryType implements IdentifiableNameable {
	...
	, HIDE_PHOTOS_IN_PHOTO_LIST( 8, "FavoriteEntryType: Hide photos in photo list"	, "FavoriteEntryType: The authors photos are shown in gallery"					, "FavoriteEntryType: The authors photos are hidden in gallery"							, "show_author_photos_in-photo-list.png", "hide_author_photos_in-photo-list.png" )
	;
