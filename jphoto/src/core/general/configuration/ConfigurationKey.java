...
public enum ConfigurationKey {
	...
	, USER_LIST_USERS_ON_PAGE( 115, "30", false, ConfigurationDataType.INTEGER, ConfigurationUnit.USER, ConfigurationTab.SYSTEM, "User list: users on page" )
//	, SYSTEM_TEMP( 10900, "1", false, ConfigurationDataType.INTEGER, ConfigurationUnit.ITEM, ConfigurationTab.SYSTEM, "Test missing configuration" )
	...
	, MEMBERS_PHOTOS_PER_DAY_LIMIT( 203, "0", false, ConfigurationDataType.INTEGER, ConfigurationUnit.PHOTO, ConfigurationTab.MEMBERS, "Photos quantity per day limit" )
	, MEMBERS_PHOTOS_PER_WEEK_LIMIT( 204, "10", false, ConfigurationDataType.INTEGER, ConfigurationUnit.PHOTO, ConfigurationTab.MEMBERS, "Photos quantity per week limit" )
...
//	, CANDIDATES_ADMIN_MUST_CONFIRM_FIRST_N_PHOTOS_OF_CANDIDATE( 300, "0", false, ConfigurationDataType.INTEGER, ConfigurationUnit.PHOTO, ConfigurationTab.CANDIDATES, "Admin must approve first N photos of candidates before they are shown in photo lists" )
	...
	, CANDIDATES_FILE_MAX_SIZE_KB( 302, "300", false, ConfigurationDataType.INTEGER, ConfigurationUnit.KILOBYTE, ConfigurationTab.CANDIDATES, "Max size of uploading file" )
	...
	, CANDIDATES_PHOTOS_PER_DAY_LIMIT( 305, "1", false, ConfigurationDataType.INTEGER, ConfigurationUnit.PHOTO, ConfigurationTab.CANDIDATES, "Photos quantity per day limit" )
	, CANDIDATES_PHOTOS_PER_WEEK_LIMIT( 306, "5", false, ConfigurationDataType.INTEGER, ConfigurationUnit.PHOTO, ConfigurationTab.CANDIDATES, "Photos quantity per week limit" )
	, CANDIDATES_CAN_COMMENT_PHOTOS( 307, "0", false, ConfigurationDataType.YES_NO, ConfigurationUnit.EMPTY, ConfigurationTab.CANDIDATES, "Candidates can comment photos" )
	, CANDIDATES_CAN_VOTE_FOR_PHOTOS( 308, "1", false, ConfigurationDataType.YES_NO, ConfigurationUnit.EMPTY, ConfigurationTab.CANDIDATES, "Candidates can vote for photos" )
	...
	, PHOTO_LIST_SHOW_PREVIEW_FOOTER( 509, "1", false, ConfigurationDataType.YES_NO, ConfigurationUnit.EMPTY, ConfigurationTab.PHOTOS, "Photo list: display photo preview footer" )
...
//	, COMMENTS_USER_MUST_HAVE_N_APPROVED_PHOTOS_BEFORE_CAN_LEAVE_COMMENT( 703, "2", false, ConfigurationDataType.INTEGER, ConfigurationUnit.PHOTO, ConfigurationTab.COMMENTS, "Member must have N approved by admin photos before ability to comment of photos (to be implemented somedays)" )
	...
	, ARCHIVING_PREVIEWS( 1400, "14", true, ConfigurationDataType.INTEGER, ConfigurationUnit.DAY, ConfigurationTab.ARCHIVING, "Who viewed the photo: DELETE information older then" )
	, ARCHIVING_VOTES( 1401, "14", true, ConfigurationDataType.INTEGER, ConfigurationUnit.DAY, ConfigurationTab.ARCHIVING, "Who apprised the photo: archive information older then" )
	, ARCHIVING_PHOTOS( 1402, "30", true, ConfigurationDataType.INTEGER, ConfigurationUnit.DAY, ConfigurationTab.ARCHIVING, "Archive photos uploaded earlie then" )
	;
